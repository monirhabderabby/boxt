      ...
      >
        <CarouselContent className="-ml-2 sm:-ml-3 md:-ml-4 pt-2">
          {data.map((testimonial) => (
            ...
            >
              <div className="bg-background border border-neutral-800 rounded-lg p-4 sm:p-6 flex flex-col hover:border-emerald-500/50 hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300 hover:-translate-y-1 h-full">
                ...
                {/* Review Title */}
                <h3 className="font-bold text-primary mb-1  text-sm sm:text-base truncate">
                  {testimonial.title}
                </h3>

                {/* Review Text */}
                <p className="text-primary text-xs sm:text-sm mb-2 grow leading-relaxed line-clamp-3">
                  {testimonial.text}
                </p>
