...
const Footer = () => {
  ...
  const certificationBadges = [
    ...
    {
      src: "/footer-logos/worcester-logo.jpeg",
      alt: "Worchester Logo",
      width: 150,
      height: 150,
    },
    {
      src: "/footer-logos/Vaillant-logo.png",
      alt: "Vaillant Logo",
      width: 100,
      height: 100,
    },
    {
      src: "/footer-logos/ideal-heating.webp",
      alt: "Ideal Heating Logo",
      width: 100,
      height: 100,
    },
  ];
    ...
    <footer className="border-t border-neutral-800">
      ...
      <div className="italic text-base text-center my-12 space-y-4 text-primary">
        ...
        <p>
          ...
          finance options here. 67PROHEAT is a broker not a lender.
        </p>
        <p>
      ...
      <div className="container mx-auto px-6 py-12">
          ...
          <div className="md:col-span-1">
            <div className="pb-6">
              ...
              <p className="text-base text-primary leading-relaxed">
                67PROHEAT Limited, 3320 Century Way, Thorpe Park, Leeds, West
                Yorkshire, LS15 8ZB.
              </p>
        ...
        <p className="text-sm text-neutral-500 leading-relaxed mb-4">
          67PROHEAT Limited is authorised and regulated by the Financial Conduct
          ...
          apply. 67PROHEAT Limited acts as a credit broker and is not a lender.
