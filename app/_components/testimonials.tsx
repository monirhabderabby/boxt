...
const testimonialData = [
    ...
    },
    {
        ...
        text: "After reading quite a few reviews regarding the 67PROHEAT service we decided to take the chance and we are so glad we did. From the initial contact to the installation everything was handled in a professional manner. The installation team were punctual, polite and efficient. We would have no hesitation in recommending 67PROHEAT to anyone looking for a new boiler.",
        author: "customer",
        time: "14 hours ago",
        rating: 5,
        verified: true,
...
const Testimonials = () => {
    return (
        <section className="w-full bg-background py-12 sm:py-16 md:py-20 px-4 sm:px-16 lg:px-20">
            <div className="container mx-auto">
                ...
                <div className="text-center mb-12 sm:mb-16 px-4">
                    <p className="text-neutral-400 text-xs sm:text-sm mb-3">
                        ...
                        based on{" "}
                        <span className="font-bold text-primary underline cursor-pointer hover:text-primary">
                            52,307 reviews
                        </span>
                        . Showing our{" "}
                ...
                {/* CTA Section */}
                <div className="max-w-5xl mx-auto bg-neutral-900/5 border border-neutral-800/10 rounded-lg p-6 sm:p-8 lg:p-10 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
                    <div className="flex items-start sm:items-center gap-4">
                        <CheckCircle2 className="w-8 h-8 text-emerald-500 shrink-0 mt-1 sm:mt-0" />
                        <h3 className="text-xl sm:text-2xl font-bold text-primary text-balance">
                            Want to know more reasons why people choose
                            67PROHEAT?
                        </h3>
                    </div>
