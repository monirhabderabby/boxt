    ...
    return (
        <footer className="border-t border-neutral-800">
            ...
            <div className="italic text-base text-center my-12 space-y-4 text-primary">
                <p>
                    <sup>1</sup>Terms and conditions apply to $125 discount
                    promo code. Click here to learn more.
                </p>
                <p>
                    <sup>2</sup>Finance available subject to status. Learn more
                    about finance options here. 67PROHEAT is a broker not a
                    lender.
                </p>
                <p>
                    <sup>3</sup>Next working day installation available when you
                    order before 3pm, subject to availability.
                </p>
            </div>
            {/* Main Footer Content */}
            <div className="container mx-auto px-6 py-12">
                    ...
                    <div className="md:col-span-1">
                        <div className="pb-6">
                            ...
                            <p className="text-base text-primary leading-relaxed">
                                67PROHEAT Limited, 3320 Century Way, Thorpe
                                Park, Leeds, West Yorkshire, LS15 8ZB.
                            </p>
                ...
                <div className="border-t border-neutral-800 pt-6 mb-6">
                    <div className="flex flex-wrap gap-4 text-base">
                        ...
                        <Link
                            ...
                            className="text-primary hover:text-orange-500 transition underline"
                        >
                            Modern Slavery Statement | 67PROHEAT
                        </Link>
                    </div>
                </div>
                ...
                <p className="text-sm text-neutral-500 leading-relaxed mb-4">
                    67PROHEAT Limited is authorised and regulated by the
                    Financial Conduct Authority. FCA register No. 767308.
                    Finance is offered through HomeServe Finance Limited (FRN
                    994955) and in some cases we also lend with Propensio
                    Finance Limited (FRN 806409). Finance available subject to
                    status, affordability and a credit check. Terms and
                    conditions apply. 67PROHEAT Limited acts as a credit broker
                    and is not a lender. Registered in England & Wales company
                    No. 08086606 VAT No. 257059782. 67PROHEAT Limited, 3320
                    Century Way, Thorpe Park, Leeds, West Yorkshire, LS15 8ZB.
                </p>

                {/* Copyright */}
                <p className="text-sm text-neutral-600">
                    ©2025 67PROHEAT Limited. All rights reserved.
                </p>
            </div>
        </footer>
    );
