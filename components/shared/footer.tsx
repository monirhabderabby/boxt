        ...
        <footer className="text-white border-t border-neutral-800">
            ...
            <div className="italic text-base text-center my-12 space-y-4 text-white/70">
                ...
                <p>
                    ...
                    about finance options here. BOXT is a broker not a lender.
                </p>
                <p>
            ...
            <div className="container mx-auto px-6 py-12">
                    ...
                    <div className="md:col-span-1">
                        <div className="pb-6">
                            ...
                            <p className="text-base text-white/70 leading-relaxed">
                                BOXT Limited, 3320 Century Way, Thorpe Park,
                ...
                <p className="text-sm text-neutral-500 leading-relaxed mb-4">
                    BOXT Limited is authorised and regulated by the Financial
                    Conduct Authority. FCA register No. 767308. Finance is
                    offered through HomeServe Finance Limited (FRN 994955) and
                    in some cases we also lend with Propensio Finance Limited
                    (FRN 806409). Finance available subject to status,
                    affordability and a credit check. Terms and conditions
                    apply. BOXT Limited acts as a credit broker and is not a
                    lender. Registered in England & Wales company No. 08086606
                    VAT No. 257059782. BOXT Limited, 3320 Century Way, Thorpe
